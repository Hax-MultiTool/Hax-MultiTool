...
if %pass% == WakeUp goto main
echo.
echo [40;30m                      [40;31 Wrong Password!
timeout 2 >nul
goto fail
:main
echo.
echo [40;30m                  [40;32m WELLCOME  BACK  %user%!!
ping localhost -n 2 >nul
cls
...
echo .
echo [40;30m ================================================================
echo [40;30m # 1. Better Pinger
echo [40;30m # 2. Office Activator 2021
echo [40;30m #
echo [40;30m #
echo [40;30m #
echo [40;30m ================================================================
...
ping localhost -n 2 >nul
ping localhost -n 2 >nul
set /p MENU= [40;30m - - - - - - hax menu - 
if %MENU% == Better Pinger goto PINGER
if %MENU% == 1 goto PINGER
:PINGER
cls
