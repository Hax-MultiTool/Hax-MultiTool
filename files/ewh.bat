...
color 04
ping localhost -n 2 -w 30> nul
echo       Try reinstalling hax or ask assistance on website
echo.
pause
goto startmenu
rem --------------------------------------------------------------------------------------------------------------------------------
...
title Rainbow Text
cls
color F0&echo.&echo.&echo.&echo.&echo.
echo Enter the text
set /p RAINBOWTEXT=^>_
cls
mode con lines=20 cols=50
...
echo.
echo Connecting to https://haxs.dev/...
echo.
